...
public class Constants {
	...
	public static final String GIT_HUB_QUERY_REPOS_BARBOSA = "https://api.github.com/search/repositories?q=language:java stars:>1000 size:<1000000&sort=stars&order=desc&per_page=100";
	public static final String GIT_HUB_QUERY_REPOS_JUVENAL = "https://api.github.com/search/repositories?q=language:java stars:225..1000 size:<1000000&sort=stars&order=desc&per_page=100";
